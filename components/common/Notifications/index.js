  ...
  return (
    <div className='intro-x dropdown relative mr-auto sm:mr-6'>
      {/* <div className='dropdown-toggle notification notification--bullet cursor-pointer'>
        <Icon name='bell' className='notification__icon' />
      </div> */}
          ...
          <div className='cursor-pointer relative flex items-center mt-5'>
            ...
            <div className='ml-2 overflow-hidden'>
              <div className='flex items-center'>
                ...
                <div className='text-xs text-gray-500 ml-auto whitespace-no-wrap'>07:00 PM</div>
              </div>
              <div className='w-full truncate text-gray-600'>
                It is a long established fact that a reader will be distracted by the readable
                content of a page when looking at its layout. The point of using Lorem
          ...
          <div className='cursor-pointer relative flex items-center mt-5'>
            ...
            <div className='ml-2 overflow-hidden'>
              <div className='flex items-center'>
                ...
                <div className='text-xs text-gray-500 ml-auto whitespace-no-wrap'>04:50 AM</div>
              </div>
              <div className='w-full truncate text-gray-600'>
